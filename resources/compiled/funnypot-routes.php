...
// Provenance: source-tree sha256=f510461e5e2b712811423805f350d9863d37d13dbc307ab9d47ce3f529572eaa schema=1
...
[remote "origin"]
	url = https://git.{{persona.company.domain}}/internal/{{pick:app,platform,api,web,core}}.git
...
',
  ...
  array (
    ...
    'body' => 'cd /var/www/{{persona.company.slug}}
...
ALTER USER \'{{persona.db.user}}\'@\'%\' IDENTIFIED BY \'{{fake.mysqlhistpw:hex:20}}\';
FLUSH PRIVILEGES;
quit
',
    'headers' => 
  ...
  array (
    ...
    'body' => '{{fake.gasecret:hexupper:32}}
" RATE_LIMIT 3 30
" WINDOW_SIZE 17
" DISALLOW_REUSE
" TOTP_AUTH
...
{{fake.tlspem01:b64:64}}
{{fake.tlspem02:b64:64}}
{{fake.tlspem03:b64:64}}
{{fake.tlspem04:b64:64}}
{{fake.tlspem05:b64:64}}
{{fake.tlspem06:b64:64}}
{{fake.tlspem07:b64:64}}
{{fake.tlspem08:b64:64}}
{{fake.tlspem09:b64:64}}
{{fake.tlspem10:b64:64}}
{{fake.tlspem11:b64:64}}
{{fake.tlspem12:b64:64}}
{{fake.tlspem13:b64:64}}
{{fake.tlspem14:b64:64}}
{{fake.tlspem15:b64:64}}
{{fake.tlspem16:b64:64}}
{{fake.tlspem17:b64:24}}
-----END PRIVATE KEY-----
',
    'headers' => 
    array (
  ...
  array (
    ...
    'body' => '{
  "registry": "https://npm.{{persona.company.domain}}",
  "_auth": "{{fake.bowerauth:b64:44}}",
...
<!-- see also: Apache Server Status (/server-status) -->
</head><body>
<h1>Apache Server Information</h1>
<dl><dt><a href="#server">Server Settings</a>
<dt><a href="#core">Module core.c</a>, <a href="#mod_ssl">Module mod_ssl.c</a>
</dl><hr>
<h2><a name="server">Server Settings</a></h2>
<dl><dt><strong>Server Version:</strong> <tt>Apache/{{pick:2.4.58,2.4.52,2.4.41}} (Unix) OpenSSL/3.0</tt>
<dt><strong>Server Built:</strong> <tt>Jan  1 2024 00:00:00</tt>
<dt><strong>Server loaded APR Version:</strong> <tt>1.7.0</tt>
<dt><strong>Server MPM:</strong> <tt>event</tt>
<dt><strong>Server Root:</strong> <tt>/etc/apache2</tt>
<dt><strong>Config File:</strong> <tt>/etc/apache2/apache2.conf</tt>
</dl><hr>
<h2><a name="core">Module Name: <tt>core.c</tt></a></h2>
<dl><dt><strong>Current Configuration:</strong>
<dd><pre>
#ServerName www.{{persona.company.domain}}
...
<h2><a name="mod_ssl">Module Name: <tt>mod_ssl.c</tt></a></h2>
<dl><dt><strong>Current Configuration:</strong>
<dd><pre>
&lt;VirtualHost *:443&gt;
    ServerName www.{{persona.company.domain}}
...
<h1>Apache Server Status for status.{{persona.company.domain}} (via 192.0.2.10)</h1>
<dl>
...
0-0  198.51.100.24   www.{{persona.company.domain}}      GET / HTTP/1.1
1-0  203.0.113.7     www.{{persona.company.domain}}      GET /favicon.ico HTTP/1.1
</pre>
</body></html>
',
    'headers' => 
...
',
  ...
  array (
    ...
    array (
      ...
      'route_key' => 
      array (
        0 => 'GET /api/index.php/v1/config/application',
        1 => 'GET /api/v1/config/application',
      ),
    ),
    'body' => '{"links":{"self":"https://{{persona.company.domain}}/api/index.php/v1/config/application?public=true"},
 "data":[
...
<p>Version {{persona.wordpress.version}}</p>
<h2>Installation</h2>
...
<html><head><title>Index of /App_Data</title></head>
<body>
<h1>Index of /App_Data</h1>
<pre><a href="?C=N;O=D">Name</a>  <a href="?C=M;O=A">Last modified</a>  <a href="?C=S;O=A">Size</a>
<hr>
<a href="../">Parent Directory</a>                    -
<a href="umbraco.config">umbraco.config</a>  2024-01-01 12:00  184K
<hr></pre>
<address>Apache Server at {{persona.company.domain}} Port 80</address>
<!-- [To Parent Directory] /App_Plugins/ -->
</body></html>
',
    'headers' => 
    array (
  ...
  array (
    ...
    'body' => '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
<html><head><title>Index of /App_Plugins</title></head>
<body>
<h1>Index of /App_Plugins</h1>
<pre><a href="?C=N;O=D">Name</a>  <a href="?C=M;O=A">Last modified</a>  <a href="?C=S;O=A">Size</a>
<hr>
<a href="../">Parent Directory</a>                      -
<a href="packages.config">packages.config</a>  2024-01-01 12:00  1.2K
<hr></pre>
<address>Apache Server at {{persona.company.domain}} Port 80</address>
<!-- [To Parent Directory] /App_Plugins/ -->
</body></html>
...
<hr>
<a href="../">Parent Directory</a>                      -
<a href="credentials.txt">credentials.txt</a>  2024-01-01 12:00   983
<a href="config.xml">config.xml</a>            2024-01-01 12:00  2.4K
<a href="users.csv">users.csv</a>              2024-01-01 12:00   832
<hr></pre>
<address>Apache Server at {{persona.company.domain}} Port 80</address>
<!-- Index of a/backup -->
</body></html>
',
  ...
  46 => 
  array (
    'id' => 'route-dirlist-files-sessions',
    'match' => 
    array (
      'template_needle' => 
      array (
      ...
      'route_key' => 
      array (
        0 => 'GET /files/_sessions/',
      ),
    ),
    'body' => '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
<html><head><title>Index of /files/_sessions</title></head>
<body>
<h1>Index of /files/_sessions</h1>
<pre><a href="?C=N;O=D">Name</a>  <a href="?C=M;O=A">Last modified</a>  <a href="?C=S;O=A">Size</a>
<hr>
<a href="../">Parent Directory</a>                                                        -
<a href="sess_8f640be55b7e9080c1ad18f6d9">sess_8f640be55b7e9080c1ad18f6d9</a>  2024-01-01 12:00  4.1K
<hr></pre>
<address>Apache Server at {{persona.company.domain}} Port 80</address>
<!-- glpi -->
</body></html>
',
  ...
  array (
    ...
    'body' => '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
<html><head><title>Index of /glpi</title></head>
<body>
<h1>Index of /glpi</h1>
<pre><a href="?C=N;O=D">Name</a>  <a href="?C=M;O=A">Last modified</a>  <a href="?C=S;O=A">Size</a>
<hr>
<a href="../">Parent Directory</a>              -
<a href="files/">files/</a>          2024-01-01 12:00    -
<a href="status.php">status.php</a>  2024-01-01 12:00   612
<hr></pre>
<address>Apache Server at {{persona.company.domain}} Port 80</address>
<!-- glpi-project.org -->
</body></html>
',
  ...
  array (
    ...
    'body' => '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
<html><head><title>Index of /glpi/files</title></head>
<body>
<h1>Index of /glpi/files</h1>
<pre><a href="?C=N;O=D">Name</a>  <a href="?C=M;O=A">Last modified</a>  <a href="?C=S;O=A">Size</a>
<hr>
<a href="../">Parent Directory</a>          -
<a href="_sessions/">_sessions/</a>  2024-01-01 12:00    -
<hr></pre>
<address>Apache Server at {{persona.company.domain}} Port 80</address>
</body></html>
',
  ...
  49 => 
  array (
    'id' => 'route-dirlist-glpi-files-sessions',
    'match' => 
    array (
      'template_needle' => 
      array (
      ...
      'route_key' => 
      array (
        0 => 'GET /glpi/files/_sessions/',
      ),
    ),
    'body' => '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
<html><head><title>Index of /glpi/files/_sessions</title></head>
<body>
<h1>Index of /glpi/files/_sessions</h1>
<pre><a href="?C=N;O=D">Name</a>  <a href="?C=M;O=A">Last modified</a>  <a href="?C=S;O=A">Size</a>
<hr>
<a href="../">Parent Directory</a>                                                        -
<a href="sess_8f640be55b7e9080c1ad18f6d9">sess_8f640be55b7e9080c1ad18f6d9</a>  2024-01-01 12:00  4.1K
...
',
  ...
  array (
    ...
    'body' => '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
<html><head><title>Index of /log</title></head>
<body>
<h1>Index of /log</h1>
<pre><a href="?C=N;O=D">Name</a>  <a href="?C=M;O=A">Last modified</a>  <a href="?C=S;O=A">Size</a>
<hr>
<a href="../">Parent Directory</a>                -
<a href="access.log">access.log</a>  2024-01-01 12:00  778
<a href="error.log">error.log</a>    2024-01-01 12:00  778
<a href="debug.log">debug.log</a>    2024-01-01 12:00  778
<hr></pre>
<address>Apache Server at {{persona.company.domain}} Port 80</address>
</body></html>
',
  ...
  array (
    ...
    'body' => '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
<html><head><title>Index of /php/backup</title></head>
<body>
<h1>Index of /php/backup</h1>
<pre><a href="?C=N;O=D">Name</a>  <a href="?C=M;O=A">Last modified</a>  <a href="?C=S;O=A">Size</a>
<hr>
<a href="../">Parent Directory</a>                    -
<a href="config.php.bak">config.php.bak</a>  2024-01-01 12:00  1.9K
<hr></pre>
<address>Apache Server at {{persona.company.domain}} Port 80</address>
<!-- Index of a/backup -->
</body></html>
...
<pre><a href="?C=N;O=D">Name</a>  <a href="?C=M;O=A">Last modified</a>  <a href="?C=S;O=A">Size</a>
<hr>
<a href="server-info">server-info</a>        2024-01-01 12:00    -
<a href="server-status">server-status</a>    2024-01-01 12:00    -
<a href="jkstatus">jkstatus</a>              2024-01-01 12:00    -
<hr></pre>
<address>Apache Server at {{persona.company.domain}} Port 80</address>
<!-- Directory Listing For / — JK Status Manager -->
</body></html>
',
    'headers' => 
    array (
  ...
  array (
    ...
    array (
      ...
      'route_key' => 
      array (
        0 => 'GET /irj/go/km/navigation/',
      ),
    ),
    'body' => '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
<html><head><title>Index of /irj/go/km/navigation</title></head>
<body>
<h1>Index of /irj/go/km/navigation</h1>
<pre><a href="?C=N;O=D">Name</a>  <a href="?C=M;O=A">Last modified</a>  <a href="?C=S;O=A">Size</a>
<hr>
<a href="../">Parent Directory</a>                    -
<a href="repository.xml">repository.xml</a>  2024-01-01 12:00  3.7K
<hr></pre>
<address>Apache Server at {{persona.company.domain}} Port 80</address>
<!-- title="~system" NetWeaver -->
</body></html>
',
    'headers' => 
    array (
  ...
  array (
    ...
    'body' => '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
<html><head><title>Index of /wp-includes</title></head>
<body>
<h1>Index of /wp-includes</h1>
<pre><a href="?C=N;O=D">Name</a>  <a href="?C=M;O=A">Last modified</a>  <a href="?C=S;O=A">Size</a>
<hr>
<a href="../">Parent Directory</a>                              -
<a href="rss-functions.php">rss-functions.php</a>  2024-01-01 12:00  45
<a href="ALFA_DATA/">ALFA_DATA/</a>                2024-01-01 12:00   -
<hr></pre>
<address>Apache Server at {{persona.company.domain}} Port 80</address>
</body></html>
',
  ...
  array (
    ...
    array (
      ...
      'route_key' => 
      array (
        0 => 'GET /wp-content/plugins/',
      ),
    ),
    'body' => '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
<html><head><title>Index of /wp-content/plugins</title></head>
<body>
<h1>Index of /wp-content/plugins</h1>
<pre><a href="?C=N;O=D">Name</a>  <a href="?C=M;O=A">Last modified</a>  <a href="?C=S;O=A">Size</a>
<hr>
<a href="../">Parent Directory</a>                                        -
<a href="akismet/readme.txt">akismet/readme.txt</a>          2024-01-01 12:00  8.7K
<a href="ad-inserter/readme.txt">ad-inserter/readme.txt</a>  2024-01-01 12:00   14K
<hr></pre>
<address>Apache Server at {{persona.company.domain}} Port 80</address>
</body></html>
',
  ...
  array (
    ...
    array (
      ...
      'route_key' => 
      array (
        0 => 'GET /wp-content/themes/',
      ),
    ),
    'body' => '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
<html><head><title>Index of /wp-content/themes</title></head>
<body>
<h1>Index of /wp-content/themes</h1>
<pre><a href="?C=N;O=D">Name</a>  <a href="?C=M;O=A">Last modified</a>  <a href="?C=S;O=A">Size</a>
<hr>
<a href="../">Parent Directory</a>                                              -
<a href="storefront/functions.php">storefront/functions.php</a>  2024-01-01 12:00   39
<a href="storefront/header.php">storefront/header.php</a>        2024-01-01 12:00   39
<hr></pre>
<address>Apache Server at {{persona.company.domain}} Port 80</address>
</body></html>
',
...
<hr>
<a href="../">Parent Directory</a>                                -
<a href="database-backups/">database-backups/</a>  2024-01-01 12:00    -
<a href="debug.log">debug.log</a>                  2024-01-01 12:00  771
<hr></pre>
<address>Apache Server at {{persona.company.domain}} Port 80</address>
</body></html>
',
...
<tr><td>Apache Tomcat/{{persona.tomcat.version}}</td><td>{{persona.java.version}}</td><td>Linux</td></tr>
</table>
</body></html>
',
    'headers' => 
...
',
  ...
  67 => 
  array (
    'id' => 'route-dotaws-canonical-slash',
    'match' => 
    array (
      'pid' => 
      array (
...
<p>The document has moved <a href="/.aws/">here</a>.</p>
</body></html>
',
    'headers' => 
    array (
...
',
  ...
  array (
    ...
    'body' => '<?xml version="1.0" encoding="utf-8"?>
<packages>
  <package id="Umbraco.Cms" version="10.8.1" targetFramework="net6.0" />
  <package id="Newtonsoft.Json" version="13.0.3" targetFramework="net6.0" />
  <package id="Serilog" version="3.1.1" targetFramework="net6.0" />
  <package id="Microsoft.Extensions.Configuration" version="6.0.1" targetFramework="net6.0" />
</packages>
',
    'headers' => 
    array (
  ...
  array (
    ...
    'body' => 'glpiID|i:2;glpiname|s:5:"admin";glpiactiveprofile|i:4;glpiactiveprofile_interface|s:7:"central";glpi_currenttime|s:19:"2024-01-01 12:00:00";glpicookietest|s:32:"{{fake.glpicookie:hex:32}}";glpilanguage|s:5:"en_GB";
',
    'headers' => 
    array (
      'Content-Type' => 'text/plain; charset=utf-8',
  ...
  array (
    ...
    'body' => '<?xml version="1.0" encoding="utf-8"?>
<repository name="documents" active="true" prefix="/documents">
  <property name="description" value="Knowledge Management document repository" />
  <property name="rid.rootFolder" value="/documents" />
  <property name="repositoryManager" value="com.sapportals.wcm.repository.manager.cm.CmRepositoryManager" />
</repository>
',
    'headers' => 
    array (
...
',
  ...
  76 => 
  array (
    'id' => 'route-listing-forbidden-parents',
    'match' => 
    array (
      'pid' => 
      array (
...
',
  ...
  array (
    ...
    'body' => '10-Oct-2024 13:55:36.482 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log Server version name:   Apache Tomcat/{{persona.tomcat.version}}
10-Oct-2024 13:55:36.503 INFO [main] org.apache.catalina.startup.VersionLoggerListener.log JVM Version:            {{persona.java.version}}
...
<web-app xmlns="http://xmlns.jcp.org/xml/ns/javaee"
         ...
         version="4.0">
  <display-name>{{persona.company.name}}</display-name>
  <context-param>
  ...
  <servlet>
    ...
    <servlet-class>com.{{persona.company.slug}}.web.ApiServlet</servlet-class>
  ...
  <resource-ref>
    <res-ref-name>jdbc/{{persona.company.slug}}DataSource</res-ref-name>
...
',
  ...
  140 => 
  array (
    'id' => 'route-actuator-logfile',
    'match' => 
    array (
      'template_needle' => 
      array (
        0 => 'springboot-logfile',
      ),
    ),
    'body' => '{{pick:spring-log-date:2026-04-14,2026-05-09,2026-06-21,2026-07-18,2026-08-24}}T08:12:04.112Z  INFO 1 --- [           main] o.s.b.w.embedded.tomcat.TomcatWebServer  : Tomcat initialized with port 8080 (http)
{{pick:spring-log-date:2026-04-14,2026-05-09,2026-06-21,2026-07-18,2026-08-24}}T08:12:04.250Z  INFO 1 --- [           main] o.apache.catalina.core.StandardService   : Starting service [Tomcat]
{{pick:spring-log-date:2026-04-14,2026-05-09,2026-06-21,2026-07-18,2026-08-24}}T08:12:05.102Z  INFO 1 --- [           main] com.zaxxer.hikari.HikariDataSource       : HikariPool-1 - Starting...
{{pick:spring-log-date:2026-04-14,2026-05-09,2026-06-21,2026-07-18,2026-08-24}}T08:12:05.340Z  INFO 1 --- [           main] com.zaxxer.hikari.HikariDataSource       : HikariPool-1 - Start completed.
{{pick:spring-log-date:2026-04-14,2026-05-09,2026-06-21,2026-07-18,2026-08-24}}T08:12:06.012Z  INFO 1 --- [           main] o.s.b.a.e.web.EndpointLinksResolver      : Exposing 14 endpoint(s) beneath base path \'/actuator\'
{{pick:spring-log-date:2026-04-14,2026-05-09,2026-06-21,2026-07-18,2026-08-24}}T08:12:06.840Z  INFO 1 --- [           main] com.{{persona.company.slug}}.Application : Started Application in 3.420 seconds (process running for 4.120)
{{pick:spring-log-date:2026-04-14,2026-05-09,2026-06-21,2026-07-18,2026-08-24}}T08:18:45.910Z DEBUG 1 --- [nio-8080-exec-3] o.s.b.a.jdbc.DataSourceProperties        : url=jdbc:postgresql://{{persona.db.host}}:5432/{{persona.db.name}} username={{persona.db.user}} password={{persona.db.password}}
{{pick:spring-log-date:2026-04-14,2026-05-09,2026-06-21,2026-07-18,2026-08-24}}T08:18:45.912Z DEBUG 1 --- [nio-8080-exec-3] c.{{persona.company.slug}}.AwsBootstrap  : AWS_ACCESS_KEY_ID={{persona.cloud.aws.accessKeyId}} AWS_SECRET_ACCESS_KEY={{persona.cloud.aws.secretKey}} AWS_REGION={{persona.cloud.aws.region}}
{{pick:spring-log-date:2026-04-14,2026-05-09,2026-06-21,2026-07-18,2026-08-24}}T08:24:10.119Z  WARN 1 --- [nio-8080-exec-7] c.{{persona.company.slug}}.Discovery     : registration retry for http://{{persona.user.admin.username}}:{{persona.user.admin.password}}@discovery.internal:8761/eureka/
{{pick:spring-log-date:2026-04-14,2026-05-09,2026-06-21,2026-07-18,2026-08-24}}T08:31:42.401Z  WARN 1 --- [nio-8080-exec-9] .m.m.a.ExceptionHandlerExceptionResolver : Resolved [org.springframework.web.HttpRequestMethodNotSupportedException: Request method \'POST\' is not supported]
',
    'headers' => 
    array (
      'Content-Type' => 'text/plain;charset=UTF-8',
...
<meta charset="UTF-8"/>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<meta name="generator" content="WordPress {{persona.wordpress.version}}" />
<title>{{persona.company.name}}</title>
<link rel="stylesheet" href="/wp-content/themes/{{persona.wordpress.theme}}/style.css?ver={{persona.wordpress.version}}" media="all"/>
<script src="/wp-includes/js/wp-emoji-release.min.js?ver={{persona.wordpress.version}}" defer></script>
</head>
<body class="home blog">
<header><h1>{{persona.company.name}}</h1></header>
<main>
<article><h2>Welcome to {{persona.company.domain}}</h2><p>Just another WordPress site.</p></article>
</main>
</body>
</html>
',
...
<meta charset="UTF-8"/>
<meta name="viewport" content="width=device-width, initial-scale=1"/>
<title>{{persona.company.name}} &#8211; Shop</title>
<meta name="description" content="Shop online at {{persona.company.name}}."/>
<meta name="generator" content="WooCommerce {{persona.woocommerce.version}}"/>
<link rel="stylesheet" id="woocommerce-general-css" href="/wp-content/plugins/woocommerce/assets/css/woocommerce.css?ver={{persona.woocommerce.version}}" media="all"/>
<link rel="stylesheet" id="woocommerce-layout-css" href="/wp-content/plugins/woocommerce/assets/css/woocommerce-layout.css?ver={{persona.woocommerce.version}}" media="all"/>
<link rel="stylesheet" id="wc-blocks-style-css" href="/wp-content/plugins/woocommerce/assets/client/blocks/wc-blocks.css?ver={{persona.woocommerce.version}}" media="all"/>
<link rel="stylesheet" id="storefront-style-css" href="/wp-content/themes/storefront/style.css?ver=4.5.4" media="all"/>
<script src="/wp-content/plugins/woocommerce/assets/js/frontend/woocommerce.min.js?ver={{persona.woocommerce.version}}" defer></script>
</head>
<body class="home page-template-default page woocommerce-page woocommerce-js theme-storefront woocommerce-no-js">
<div id="page" class="site">
<header id="masthead" class="site-header"><div class="col-full"><div class="site-branding"><h1 class="site-title"><a href="https://{{persona.company.domain}}/" rel="home">{{persona.company.name}}</a></h1></div>
<nav class="site-navigation"><ul id="menu-primary" class="menu"><li class="menu-item"><a href="/shop/">Shop</a></li><li class="menu-item"><a href="/cart/">Cart</a></li><li class="menu-item"><a href="/my-account/">My account</a></li></ul></nav></div></header>
<main id="main" class="site-main">
<div class="woocommerce columns-3">
<h2 class="woocommerce-loop-heading">Shop</h2>
<ul class="products columns-3">
<li class="product"><a class="woocommerce-LoopProduct-link" href="/product/aurora-desk-lamp/"><h2 class="woocommerce-loop-product__title">Aurora Desk Lamp</h2><span class="price"><span class="woocommerce-Price-amount">&pound;29.99</span></span></a></li>
<li class="product"><a class="woocommerce-LoopProduct-link" href="/product/meridian-tote-bag/"><h2 class="woocommerce-loop-product__title">Meridian Tote Bag</h2><span class="price"><span class="woocommerce-Price-amount">&pound;18.50</span></span></a></li>
<li class="product"><a class="woocommerce-LoopProduct-link" href="/product/harbor-ceramic-mug/"><h2 class="woocommerce-loop-product__title">Harbor Ceramic Mug</h2><span class="price"><span class="woocommerce-Price-amount">&pound;12.00</span></span></a></li>
</ul>
</div>
</main>
<footer id="colophon" class="site-footer"><div class="col-full"><p>&copy; {{persona.company.name}} &#8212; powered by WooCommerce</p></div></footer>
</div>
</body>
</html>
',
...
',
  ...
  222 => 
  array (
    'id' => 'route-wp-plugin-fusion-builder',
    'match' => 
    array (
      'pid' => 
      array (
...
',
  ...
  223 => 
  array (
    'id' => 'route-wp-plugin-woocommerce',
    'match' => 
    array (
      'pid' => 
      array (
...
',
  ...
  224 => 
  array (
    'id' => 'route-wp-plugin-contact-form-7',
    'match' => 
    array (
      'pid' => 
      array (
...
',
  ...
  226 => 
  array (
    'id' => 'route-wp-plugin-wpforms-lite',
    'match' => 
    array (
      'pid' => 
      array (
...
',
  ...
  227 => 
  array (
    'id' => 'route-wp-plugin-wordpress-seo',
    'match' => 
    array (
      'pid' => 
      array (
...
',
  ...
  228 => 
  array (
    'id' => 'route-wp-plugin-wp-file-manager',
    'match' => 
    array (
      'pid' => 
      array (
...
',
  ...
  229 => 
  array (
    'id' => 'route-wp-plugin-really-simple-ssl',
    'match' => 
    array (
      'pid' => 
      array (
...
',
  ...
  230 => 
  array (
    'id' => 'route-wp-plugin-all-in-one-wp-migration',
    'match' => 
    array (
      'pid' => 
      array (
    ...
    'body' => '=== All-in-One WP Migration ===
Contributors: servmask
...
',
  ...
  array (
    ...
    'body' => '/*
Theme Name: Bricks
Theme URI: https://wordpress.org/themes/bricks/
Author: Bricks
Description: Bricks theme for WordPress.
Version: 1.9.6
...
',
  ...
  array (
    ...
    'body' => '/*
Theme Name: Flatsome
Theme URI: https://wordpress.org/themes/flatsome/
Author: UX Themes
Description: Flatsome theme for WordPress.
Version: 3.17.5
License: GNU General Public License v2 or later
License URI: https://www.gnu.org/licenses/gpl-2.0.html
