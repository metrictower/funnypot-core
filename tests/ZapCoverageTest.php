...
final class ZapCoverageTest extends TestCase
{
    ...
    public function test_attack_rule_count_is_59_plus_the_two_new_rules(): void
    {
        ...
        self::assertCount(76, $rules, 'attack rule count must be 59 (baseline) + 2 (imds-base, wp-admin-redirect) + 2 (lfi-sshkey, lfi-hostname) + 1 (imds-identity-doc) + 1 (FP-0229 nextjs-rsc) + 1 (FP-0232 verbose-error-volatile) + 1 (FP-0234 ssti-multifence) + 1 (FP-0235 crlfuzz-echo) + 7 (FP-0143 knock-knock IoT/edge rules) + 1 (FP-0259 xss-baseline)');
