...
final class PhpMyAdminMockAuthTest extends TestCase
{
    ...
    public function test_both_rules_compiled_unique_and_ordered(): void
    {
        ...
        self::assertCount(75, $rules, 'compiled corpus must be 57 (original baseline) + 2 (this pair) + 9 (unrelated, since: imds-base, wp-admin-redirect, lfi-sshkey, lfi-hostname, imds-identity-doc, FP-0229 nextjs-rsc, FP-0232 verbose-error-volatile, FP-0234 ssti-multifence, FP-0235 crlfuzz-echo) + 7 (FP-0143 knock-knock: hikvision-sdk-36260, hikvision-sdk-desc, gpon-10561, fiberhome-27973, netgear-6277, xdebug, node-red)');
