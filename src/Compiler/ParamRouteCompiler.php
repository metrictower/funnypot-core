...
final class ParamRouteCompiler
{
     ...
     * {{xml:match.*}} are fine. Mirrors EmulatorCompiler::assertHtmlReflectionSafe; the walk covers the
     * base response and every behavior/traversal nested response. Compile-time only, never compiled in.
     *
     * @param array<string,mixed> $doc
     */
