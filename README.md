...
Fiberhome's emitted `/boaform/admin/formLogin` form now has a normal POST follow-through: every
ordinary or malformed submission receives the same inert failed-login page, with no credential
