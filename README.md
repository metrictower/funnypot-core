...
| Metric | Count |
|---|---|
| Authored decoy records | 324 |
| Authored families | 78 |
| &nbsp;&nbsp;tier `attack` | 66 |
| &nbsp;&nbsp;tier `attack-ai` | 9 |
| &nbsp;&nbsp;tier `attack-crs` | 4 |
| &nbsp;&nbsp;tier `new-page` | 243 |
