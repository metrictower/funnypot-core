...
→ `compile-routes` → `compile-params` → `merge-routes` → `build-manifest` → `map`; `merge-routes` is
...
| Metric | Count |
|---|---|
| Authored decoy records | 328 |
| Authored families | 79 |
| &nbsp;&nbsp;tier `attack` | 70 |
| &nbsp;&nbsp;tier `attack-ai` | 9 |
| &nbsp;&nbsp;tier `attack-crs` | 4 |
| &nbsp;&nbsp;tier `new-page` | 243 |
...
| Content enrichers (not route claimers) | 209 |
...
run `composer build`, and review every changed `templates/generated`/`templates/attack-ai` byte and
